...
public class Bank implements Serializable {
    ...
    public void sendBoxInterItems() {
        this.player.getPackets().sendInterSetItemsOptionsScript(11, 17, 93, 6, 5, new String[]{"Deposit-1", "Deposit-5", "Deposit-10", "Deposit-All", "Deposit-X", "Examine"});
        this.player.getPackets().sendUnlockIComponentOptionSlots(11, 17, 0, 27, new int[]{0, 1, 2, 3, 4, 5});
    }
    ...
    public void openPlayerBank(Player victim) {
        if (victim != null) {
            this.player.getInterfaceManager().sendInterface(762);
            this.player.getInterfaceManager().sendInventoryInterface(763);
            this.player.getPackets().sendItems(95, victim.getBank().getContainerCopy());
            this.refreshViewingTab();
            this.refreshTabs();
            this.unlockButtons();
        }
    ...
    public void sendItems() {
        this.player.getPackets().sendItems(95, this.getContainerCopy());
    }

    public void refreshItems(int[] slots) {
        this.player.getPackets().sendUpdateItems(95, this.getContainerCopy(), slots);
    }
