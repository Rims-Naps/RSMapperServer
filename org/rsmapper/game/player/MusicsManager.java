...
public final class MusicsManager implements Serializable {
    ...
    public void refreshPlayListConfigs() {
        ...
        for(i = 0; i < this.playList.size(); i += 2) {
            ...
            if (musicId2 != null) {
                ...
                configValue = musicIndex | Short.MIN_VALUE;
            }
    ...
    public void unlockMusicPlayer() {
        this.player.getPackets().sendUnlockIComponentOptionSlots(187, 1, 0, ClientScriptMap.getMap(1351).getSize() * 2, new int[]{0, 2, 3});
    }
