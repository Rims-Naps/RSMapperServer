...
import org.rsmapper.game.Hit.HitLook;
...
public class Player extends Entity {
        ...
        if (hit.getLook() == HitLook.MELEE_DAMAGE || hit.getLook() == HitLook.RANGE_DAMAGE || hit.getLook() == HitLook.MAGIC_DAMAGE) {
            ...
            if (source != null) {
                ...
                if (ammy == 11090) {
                    ...
                    if (hpPercent <= 20.0) {
                        this.heal((int)((double)this.getMaxHitpoints() * 0.3));
                    ...
                    hit.setDamage((int)((double)hit.getDamage() * 0.75));
                }

                if (this.polDelay > Utils.currentTimeMillis()) {
                    hit.setDamage((int)((double)hit.getDamage() * 0.5));
                }
                ...
                if (this.getTemporaryAttributes().get("cast_vengeance") != null && this.getTemporaryAttributes().get("cast_vengeance").equals(true) && hit.getDamage() >= 4) {
                    ...
                    source.applyHit(new Hit(this, (int)((double)hit.getDamage() * 0.75), HitLook.REGULAR_DAMAGE));
                }
    ...
    public void sendRandomJail(Player var1) {
    ...
    public void performInstantSpecial(int weaponId) {
        ...
        if (this.combatDefinitions.hasRingOfVigour()) {
            specAmt = (int)((double)specAmt * 0.9);
        }
        ...
        if (this.combatDefinitions.getSpecialAttackPercentage() < specAmt) {
            ...
            switch (weaponId) {
                ...
                case 14632:
                    ...
                    this.getSkills().set(1, enhanced ? (int)((double)this.getSkills().getLevelForXp(1) * 1.15) : this.getSkills().getLevel(1) + 8);
                    WorldTasksManager.schedule(new WorldTask() {
                        int count = 5;
                ...
                case 13472:
                    ...
                    int defence = (int)((double)this.getSkills().getLevelForXp(1) * 0.9);
                    int attack = (int)((double)this.getSkills().getLevelForXp(0) * 0.9);
                    int range = (int)((double)this.getSkills().getLevelForXp(4) * 0.9);
                    int magic = (int)((double)this.getSkills().getLevelForXp(6) * 0.9);
                    int strength = (int)((double)this.getSkills().getLevelForXp(2) * 1.2);
