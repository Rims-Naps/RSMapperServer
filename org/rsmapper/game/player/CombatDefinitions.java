...
public final class CombatDefinitions implements Serializable {
    ...
    public void refreshSpellBook() {
        if (this.spellBook == 0) {
            ...
            this.player.getPackets().sendConfig(1376, this.sortSpellBook << 6 | (this.showCombatSpells ? 0 : 8192) | (this.showMiscallaneousSpells ? 0 : 16384) | (this.showTeleportSpells ? 0 : '?'));
        }
    ...
    public void sendUnlockAttackStylesButtons() {
        for(int componentId = 11; componentId <= 14; ++componentId) {
            this.player.getPackets().sendUnlockIComponentOptionSlots(884, componentId, -1, 0, new int[]{0});
        }
