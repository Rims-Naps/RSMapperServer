...
public final class PlayerLook {
    ...
    public static void openCharacterCustomizing(Player player) {
        ...
        player.getPackets().sendUnlockIComponentOptionSlots(interfaceId, 45, 0, 11, new int[]{0});
        player.getPackets().sendUnlockIComponentOptionSlots(interfaceId, 107, 0, 50, new int[]{0});
        player.getPackets().sendUnlockIComponentOptionSlots(interfaceId, 111, 0, 250, new int[]{0});
    ...
    public static void openBeardInterface(Player player) {
        ...
        player.getPackets().sendUnlockIComponentOptionSlots(309, 10, 0, 63, new int[]{0});
        player.getPackets().sendUnlockIComponentOptionSlots(309, 16, 1, 49, new int[]{0});
        player.getTemporaryAttributes().put("hairSaloon", true);
    }
