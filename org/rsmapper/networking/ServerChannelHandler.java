...
public final class ServerChannelHandler extends SimpleChannelUpstreamHandler {
    ...
    private ServerChannelHandler() {
        ...
        try {
            ...
            ChannelException e = var2;
            RsMapperServer.print("<font style=\"color:red\">" + e.getMessage() + " ...Another instance of the server may already be running! There can only be one.</font>");
        }
