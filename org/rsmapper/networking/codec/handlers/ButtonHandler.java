                            ...
                            if (interfaceId != 458) {
                                ...
                                if (interfaceId == 387) {
                                    ...
                                    if (componentId == 8 && packetId == 25) {
                                        ...
                                        switch (packetId) {
                                            case 4:
                                                Magic.sendNormalTeleportSpell(player, 1, 0.0, new WorldTile(2673, 3374, 0), new int[0]);
                                            case 52:
                                                break;
                                            case 64:
                                                Magic.sendNormalTeleportSpell(player, 1, 0.0, new WorldTile(2606, 3223, 0), new int[0]);
                                                break;
                                            default:
                                ...
                                if (interfaceId != 548 && interfaceId != 746 && interfaceId != 387) {
                                        ...
                                        if (interfaceId == 193) {
                                            ...
                                            if (interfaceId == 499) {
                                                ...
                                                if (componentId == 17) {
                                                    ...
                                                    player.getControllerManager().startController("CorpBeastControler", new Object[0]);
                                                } else if (componentId == 18) {
                                    ...
                                    if (componentId == 11) {
                                        if (tabId == 20771) {
                                            switch (packetId) {
                                                case 4:
                                                    Magic.sendNormalTeleportSpell(player, 1, 0.0, new WorldTile(2668, 3374, 0), new int[0]);
                                                case 52:
                                                default:
                                                    break;
                                                case 64:
                                                    Magic.sendNormalTeleportSpell(player, 1, 0.0, new WorldTile(2606, 3220, 0), new int[0]);
                                            }
                                        }
        ...
        if (slotId < 15) {
            ...
            if (item != null) {
                if (player.getInventory().addItem(item.getId(), item.getAmount())) {
                    ...
                    player.getEquipment().refresh(new int[]{slotId});
                    ...
                    if (targetSlot == -1) {
                        ...
                        if (isTwoHandedWeapon && !player.getInventory().hasFreeSlots() && player.getEquipment().hasShield()) {
                            ...
                            if (!hasRequiriments) {
                                ...
                                if (targetSlot == 3) {
                                    if (isTwoHandedWeapon && player.getEquipment().getItem(5) != null) {
                                        if (!player.getInventory().addItem(player.getEquipment().getItem(5).getId(), player.getEquipment().getItem(5).getAmount())) {
                                            ...
                                            player.getInventory().refresh(new int[]{slotId});
                                            return true;
                                        }
                                ...
                                player.getEquipment().refresh(new int[]{targetSlot, targetSlot == 3 ? 5 : (targetSlot == 3 ? 0 : 3)});
                                player.getAppearence().generateAppearenceData();
