    ...
    final void decode(InputStream stream) {
        ...
        if (~i_21_ != -1) {
            ...
            for(this.anIntArray4705 = new int[11]; i_21_ != 0; i_21_ = stream.readUnsignedByte()) {
                ...
                this.aByteArray4806[i_22_] = (byte)b_23_;
                this.aByteArray4733[i_22_] = (byte)b_24_;
            }
        }
        ...
        b_23_ = 15 & i_22_;
        if (b_23_ > 0) {
            this.aStringArray4686 = new String[b_23_];

            for(b_24_ = 0; ~b_24_ > ~b_23_; ++b_24_) {
                this.aStringArray4686[b_24_] = stream.readString();
            }
        }
