                ...
                while(true) {
                    ...
                    do {
                        ...
                        for(n1 = 1; n1 <= alphaSize; ++n1) {
                            ...
                            for(zz = heap[yy]; weight[zz] < weight[heap[yy >> 1]]; yy >>= 1) {
                                heap[yy] = heap[yy >> 1];
                            }
                                                            ...
                                                            if (block[i1 + 2] == block[i2 + 2]) {
                                                                if (block[i1 + 3] == block[i2 + 3]) {
                                                                    if (block[i1 + 4] == block[i2 + 4]) {
                                                                        ...
                                                                        } else if ((block[i1 + 5] & 255) <= (block[i2 + 5] & 255)) {
                                                                            break label179;
                                                                        }
                                                                    } else if ((block[i1 + 4] & 255) <= (block[i2 + 4] & 255)) {
                                                                        break label179;
                                                                    }
                                                                } else if ((block[i1 + 3] & 255) <= (block[i2 + 3] & 255)) {
                                                                    break label179;
                                                                }
                                                            } else if ((block[i1 + 2] & 255) <= (block[i2 + 2] & 255)) {
                                                                break label179;
                                                            }
                                                        } else if ((block[i1 + 1] & 255) <= (block[i2 + 1] & 255)) {
                                                            break label179;
                                                        }
                                                    }
                                                }
                            ...
                            if (i < 0) {
                                ...
                                while(i != 1) {
                                    ...
                                    for(ss = i; ss <= 255; ++ss) {
                                        ...
                                        for(a2update = runningOrder[j - i]; ftab[a2update + 1 << 8] - ftab[a2update << 8] > bbSize; a2update = runningOrder[j - i]) {
