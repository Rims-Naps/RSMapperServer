        ...
        while(true) {
            while(flag18) {
                ...
                for(l4 = 0; l4 < k4; ++l4) {
                    ...
                    for(j5 = abyte0[i5]; i5 > 0; i5 = (byte)(i5 - 1)) {
                        abyte0[i5] = abyte0[i5 - 1];
                    }

                    abyte0[0] = (byte)j5;
                    entry.aByteArray2219[l4] = (byte)j5;
                }
                ...
                for(l4 = 0; l4 < j4; ++l4) {
                    ...
                    for(i9 = 0; i9 < i4; ++i9) {
                        if (entry.aByteArrayArray2229[l4][i9] > j5) {
                            j5 = entry.aByteArrayArray2229[l4][i9];
                        }
                    ...
                    method1786(entry.anIntArrayArray2230[l4], entry.anIntArrayArray2218[l4], entry.anIntArrayArray2210[l4], entry.aByteArrayArray2229[l4], byte8, j5, i4);
                    ...
                    while(k5 != l4) {
                        ...
                        if (k5 != 0 && k5 != 1) {
                            ...
                            if (i6 < 16) {
                                ...
                                j7 = i6 / 16;
                                i8 = i6 % 16;
                                byte10 = entry.anIntArray2226[j7] + i8;

                                for(byte6 = entry.aByteArray2204[byte10]; byte10 > entry.anIntArray2226[j7]; --byte10) {
                                    entry.aByteArray2204[byte10] = entry.aByteArray2204[byte10 - 1];
                                }
                            ...
                            do {
                                ...
                                for(i8 = method1790(j7, entry); i8 > ai[j7]; i8 = i8 << 1 | byte10) {
                                    ++j7;
